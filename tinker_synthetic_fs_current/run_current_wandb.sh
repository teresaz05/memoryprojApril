...
BASE_RUN_NAME=synthfs_qwen35_executor_pi_alltrain_bs16_gs4_mt32_ans32_ansrep4_probe4int8_ansdelta_g31litepreview_eff_memtrim2_seed2
...
python train_synthetic_fs_rl.py \
  ...
  step_filesystem_maturity_delta_scale=0.5 \
