#!/usr/bin/env python3
"""Run the docsummaryaux merge2 experiment without the old shell wrapper stack."""
...
from april_version_code.methods import docsummaryaux_merge2 as experiment


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Run the docsummaryaux merge2 experiment on the q50 support-only dataset.')
    ...
    parser.add_argument('--aux-doc-summary-budget-tokens', type=int, default=0)
...
def main() -> None:
    ...
    run_script_main(
        ...
        [
            ...
            '--aux_doc_summary_budget_tokens', str(args.aux_doc_summary_budget_tokens),
